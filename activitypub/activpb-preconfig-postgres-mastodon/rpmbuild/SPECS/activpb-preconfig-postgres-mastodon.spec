...
Source0: activpb-preconfig-postgres-mastodon-1.0.tar.gz
BuildArch: noarch
...
MODULE_CONFIG_DIR="/usr/local/pbase-data/admin-only/module-config.d"
MODULE_SAMPLES_DIR="/usr/local/pbase-data/activpb-preconfig-postgres-mastodon/module-config-samples"
...
echo "  yum -y install activpb-mastodon"
echo ""

%files
%defattr(600,root,root,700)
/usr/local/pbase-data/activpb-preconfig-postgres-mastodon/module-config-samples/activpb_mastodon.json
/usr/local/pbase-data/activpb-preconfig-postgres-mastodon/module-config-samples/pbase_lets_encrypt.json
/usr/local/pbase-data/activpb-preconfig-postgres-mastodon/module-config-samples/pbase_postgres.json
/usr/local/pbase-data/activpb-preconfig-postgres-mastodon/module-config-samples/pbase_s3storage.json
/usr/local/pbase-data/activpb-preconfig-postgres-mastodon/module-config-samples/pbase_smtp.json
