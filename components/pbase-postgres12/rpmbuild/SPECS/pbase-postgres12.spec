...
Requires: jq, postgresql12 postgresql12-server postgresql12-contrib postgresql12-libs
...
parseConfig "CONFIG_DB_CHARSET"  ".pbase_postgres12[0].default.database[0].characterSet" "UTF8"
parseConfig "CONFIG_CREATEDB"    ".pbase_postgres12[0].default.database[0].grantCreateDatabase" "false"
