Name: pbase-java11-dev-tools
Version: 1.0
Release: 1
Summary: PBase Java 11, Maven and other Development Tools rpm
Group: System Environment/Base
License: Apache-2.0
URL: https://pbase-foundation.com
Source0: pbase-java11-dev-tools-1.0.tar.gz
BuildArch: noarch
BuildRoot: %{_tmppath}/%{name}-buildroot

Provides: pbase-java11-dev-tools
Requires: maven,java-11-openjdk-devel,git,perl,rpm-build,vim,mc,nano,curl,wget,tree,zip,unzip,redhat-lsb-core,gcc,gcc-c++,make

%description
Configures Java 11 Development Tools
...
echo "PBase Java 11, JAVA_HOME environment-variable, Maven and other Development Tools"
...
#DOWNLOADS_DIR="/usr/local/pbase-data/pbase-java11-dev-tools/downloads/"
...
#/bin/cp -rf /usr/local/pbase-data/pbase-java11-dev-tools/etc-profile-d/pbase-maven.sh /etc/profile.d
...
%files
%defattr(-,root,root,-)
/usr/local/pbase-data/pbase-java11-dev-tools/etc-profile-d/pbase-ant.sh
/usr/local/pbase-data/pbase-java11-dev-tools/etc-profile-d/pbase-java.sh
/usr/local/pbase-data/pbase-java11-dev-tools/etc-profile-d/pbase-maven.sh
