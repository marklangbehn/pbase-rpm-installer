...
Source0: pbase-preconfig-nodejs14-1.0.tar.gz
BuildArch: noarch
BuildRoot: %{_tmppath}/%{name}-buildroot

Provides: pbase-preconfig-nodejs14
Requires: git, curl, gcc-c++ make

%description
Configure yum repo for NodeJS 14.x
...
/bin/cp -f --no-clobber /usr/local/pbase-data/pbase-preconfig-nodejs14/etc-pki-rpm-gpg/NODESOURCE-GPG-SIGNING-KEY-EL  /etc/pki/rpm-gpg

echo ""
echo "NodeSource Node JS 14.x repo configured."
