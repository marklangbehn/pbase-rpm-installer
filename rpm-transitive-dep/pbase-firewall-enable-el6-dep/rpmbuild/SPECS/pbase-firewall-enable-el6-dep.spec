Name: pbase-firewall-enable-el6-dep
Version: 1.0
Release: 1
Summary: PBase firewall enable transitive dependency - EL6
...
%description
Firewall enable transitive dependency - EL6
...
echo "PBase firewall enable transitive dependency - EL6"
